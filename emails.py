...
sender_email = "westin.musser@mindsmatterseattle.org"
recipient_email = "serena.zhu@mindsmatterseattle.org"
sender_password = "wnfprxuvgfwwoaeh"
smtp_server = 'smtp.gmail.com'
smtp_port = 465
path_to_file = 'westin.musser@mindsmatterseattle.org.png'
...
with open(path_to_file,'rb') as file:
    ...
    message.attach(MIMEApplication(file.read(), Name="qr_code.png"))
